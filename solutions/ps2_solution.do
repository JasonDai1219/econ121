...
keep if hours18>=35*50 & hours18<. & laborinc18>0 & laborinc18<.

//Generate new variables
gen lnw = ln(laborinc18/hours18)

gen exper = age79 + (2018-1979) - educ - 5
gen exper2 = exper^2
...
//squared term). Since the NLSY in 2018 only had mature 
