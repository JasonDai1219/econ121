...
nlsy79 <- nlsy79_raw[which(nlsy79_raw$hours18 >= 35*50 & nlsy79_raw$laborinc18>0),]

# Generate new variables
nlsy79$lnw <- log(nlsy79$laborinc18/nlsy79$hours18)

nlsy79$exper <- nlsy79$age79 + (2018-1979) - nlsy79$educ - 5
...
# in the NLSY (and are insignificantly different from 
# zero in the weighted regression). The difference is 
